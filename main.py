...
del_frame = Frame(root, bd=4, relief=RIDGE, bg="red")  # Set background color to red
...
adminlogin = Button(del_frame, text="Admin Login", fg="black", font=15, command=calladmin)
